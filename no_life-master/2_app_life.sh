...
insert overwrite table ga.interface_app_life_20210930 partition(mobile_id_end_no)
select 
mobile_id, 
case 
...
from (select mobile_id from profile.dws_app_all_20210530 where app_type = '生活类' group by mobile_id) a;
